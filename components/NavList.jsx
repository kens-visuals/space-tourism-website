...
export default function NavList() {
  ...
  return (
    <nav className="shadow-5xl absolute right-0 z-50 h-screen w-3/4 bg-white bg-opacity-10 backdrop-blur-[20px] backdrop-filter  md:static md:flex md:h-auto md:w-auto md:items-center md:px-14 md:pt-10">
